...
class ViewController: UIViewController, FrameExtractorDelegate {
    ...
    func onNewFrame(frame: UIImage) {
        self.cameraView.image = self.markerAR.processFrame(frame)
        self.camera.transform = self.markerAR.getCameraPose()
    }
    ...
    func setupScene() {
        ...
        let projection = markerAR.getCameraProjection()
